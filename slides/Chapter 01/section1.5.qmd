...
![](images/5_null.png){fig-alt="Example null distribution." fig-align="center"}
...
::::: columns
::: {.column width="50%"}
![](images/5_small.png){fig-alt="Null distribution where n=30. Mound shaped with gaps." fig-align="center"}
:::

::: {.column width="50%"}
![](images/5_large.png){fig-alt="Null distribution where n=300. Mound shaped and completely filled in." fig-align="center"}
:::
:::::
...
![](images/5_normalapp.png){fig-alt="Screenshot of the One Proportion Applet used to find values using the theory based approach." fig-align="center"}
...
## Halloween Treats {style="font-size: 35px"}
