...
-   Goal: know which parameter values are plausible
...
-   A confidence interval tells us if 0.5 is plausible or not
...
-   Population of Interest: **All Minnesota adults**

-   Parameter of Interest: [$\pi$=]{.fragment}**Long run proportion of Minnesota adults that feel marijuana should be legalized**

-   Sample/sample size: **n = 800 surveyed Minnesota adults**
...
## Legalizing Medical Marijuana Activity
...
## Activity Results {style="font-size: 22px"}
...
![](images/1_minnesota.png){fig-alt="Article snippet: The polly surveyed 800 Minnesota adults between Feb. 10 and 12 and has a margin of sampling error of plus or minus 3.5 percentage points." fig-align="center"}
...
-   If we sampled from the same population 20 times, we would expect 19 samples (95%) to contain the true population parameter
