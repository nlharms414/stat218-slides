...
-   Average distance data points are from the mean, OR

-   Average distance sample means/proportions are from the center of the distribution
:::

::: {.column width="50%"}
### Standard Error (SE)

-   An estimate of SD, based on the data

-   Formula differs for numerical vs. categorical data
:::
:::::
...
-   $n=800$
-   $SE=\sqrt{\frac{\hat{p}*(1-\hat{p})}{n}}=\sqrt{\frac{0.15*(1-0.51)}{800}}=0.0177$
...
-   If SS is "inside the twos", fail to reject the null
hypothesis
