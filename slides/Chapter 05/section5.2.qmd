...
## Finding Strength of Evidence (3 Methods) {.center}
...
-   We will use it to:
    ...
    -   Obtain a standard deviation for calculations
...
$$\hat{p}_D-\hat{p}_C$$ $$= 0.667-0.2$$ $$=0.467$$
...
$$SS = \frac{\hat{p}_D-\hat{p}_C-0}{SD\: from\: Applet}$$ $$=\frac{0.467}{0.179}$$ $$=2.61$$
:::
:::::
...
-   If the hypothesized parameter value is OUTSIDE the confidence interval, reject $H_0$
